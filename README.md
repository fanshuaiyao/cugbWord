...
- **页面设置**：页边距、页眉页脚距离
- **页眉页脚**：首页不同选项
- **页码**：支持模板配置按节设置页码；地大模板默认第一节首页不同、前置部分罗马数字、正文从 1 开始阿拉伯数字
- **页码**：支持前置部分与正文按节分别控制页码样式
...
- **自动生成目录**（在英文摘要后插入目录标题和自动目录）
- **按节页码**（目录及以前部分可用罗马数字，正文可从 1 开始阿拉伯数字）
...
- ✅ 目录自动生成
- 🚧 段落智能匹配持续优化中
- ✅ 页码自动处理（已支持按节控制：前置部分罗马数字、正文阿拉伯数字）
